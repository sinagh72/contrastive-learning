...
from train import train_simclr, train_new_simclr
...
if __name__ == "__main__":
    ...
    CHECKPOINT_PATH = "./kaggle_saved_models_balanced_2cores_acc/SimCLR/"
    ...
    for i in range(CV):
        ...
        simclr_model = train_new_simclr(devices=devices,
                                        strategy=strategy,
