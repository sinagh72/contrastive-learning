...
class LinearModel(pl.LightningModule):
    ...
    def __init__(self, feature_dim, classes, lr, weight_decay, metric="accuracy", max_epochs=100):
        """
        ...
        self.model = nn.Linear(self.hparams.feature_dim, len(self.hparams.classes))
